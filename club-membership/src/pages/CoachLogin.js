...
export const CoachLogin = () => {
    ...
    const handleSubmit = (event) => {
        ...
        // axios.post('https://dancesyncrecclub-production.up.railway.app/api/coach-login', { username, password })
        axios.post(`${process.env.REACT_APP_API_URL}/api/coach-login`, { username, password })
            .then(res => {
        ...
        <div className=' bg-slate-300 h-screen overflow-hidden'>
            ...
            <div className='flex flex-row h-full'>
                <form className='flex flex-col box flex-2' onSubmit={handleSubmit}>
                    ...
                    <h1 className=' text-center font-semibold text-6xl bg-red-100 py-1 px-2 reddit-mono'>Coach.</h1>
                    </div>
